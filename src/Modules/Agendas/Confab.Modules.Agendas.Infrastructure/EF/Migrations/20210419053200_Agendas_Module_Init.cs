        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmisionsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpeakerSubmission", x => new { x.SpeakersId, x.SubmisionsId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_SpeakerSubmission_Submissions_SubmisionsId",
                        column: x => x.SubmisionsId,
                        principalSchema: "agendas",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpeakerSubmission_SubmisionsId",
                schema: "agendas",
